...
-- Trigger para actualizar el contador de reacciones cuando se agrega una reacción
DELIMITER //
...
-- Trigger para actualizar el contador de reacciones cuando se elimina una reacción
DELIMITER //
